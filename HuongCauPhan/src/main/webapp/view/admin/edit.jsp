...
<html >
  <head>
	...
	<link href="<c:url value='/template/adcss/bootstrap.css'/>" rel="stylesheet" type="text/css" />
	...
	<script type="text/javascript" src="<c:url value='/template/ckediter/ckediter.js'/>" > </script>
...
<table width="100%" cellspacing="0" cellpadding="0" border="0" class="ucp_info" >
    <tbody><tr><td></td>
        <td class="subleft">
            <a href="<c:url value='/template/view'/>">TRANG CHỦ</a>
        </td>
        <td class="subcen">
...
<table border="0" style="width: 100%; border-collapse: collapse" class="ucp_tbl form">
    ...
    <tr>
        ...
        <td style="width: 400px"><input type="text" name="FamilyName" id="FamilyName" style="width: 380px" value='/template<c:out value="${prname}"></c:out>'></td>
        <td style="width: 120px">Tên thủy tổ</td>
        <td style="width: 180px"><input type="text" name="Ancestor" id="Ancestor" value='/template<c:out value="${prancestor}"></c:out>'></td>
        <td>Truy cập gần đây:</td>
        <td id="recently"></td>
    </tr>
    <tr>
        <td style="width: 110px">Ngày tế thu (âm lịch)</td>
        <td style="width: 200px"><input type="text" name="AutumnAnniversary" placeholder="yyyy/mm/dd" id="AutumnAnniversary" value='/template<c:out value="${prt.cultural_autumn_day}"></c:out>'></td>
        <td style="width: 120px">Ngày tế xuân (âm lịch)</td>
        <td style="width: 160px"><input type="text" name="SpringAnniversary" placeholder="yyyy/mm/dd" id="SpringAnniversary" value='/template<c:out value="${prt.cultural_spring_day}"></c:out>'></td>
   ...
   <!-- <c:out value="${prt.address}"></c:out> -->
    <tr>
        ...
        <td>
            ...
            <select id="cboAddress" style="width: 150px; height: 25px; float: left" >
                <option value='/template1'>Quảng Nam </option><option value='/template2	'>Đà Nẵng</option><option value='/template3'>Sài Gòn </option><option value='/template4'>Hà Nội </option><option value='/template5'>An Giang </option><option value='/template6'>Bà Rịa Vũng Tàu </option><option value='/template7'>Bạc Liêu </option><option value='/template8'>Bắc Cạn </option><option value='/template9'>Bắc Giang </option><option value='/template10'>Bắc Ninh </option><option value='/template11'>Bến Tre </option><option value='/template12'>Bình Dương </option><option value='/template13'>Bình Định </option><option value='/template14'>Bình Dương </option><option value='/template15'>Bình Định </option><option value='/template16'>Bình Phước </option><option value='/template17'>Bình Thuận </option><option value='/template18'>Cà Mau </option><option value='/template19'>Cao Bằng </option><option value='/template20'>Cần Thơ </option><option value='/template21'>Đắc Lắc </option><option value='/template22'>Đồng Nai </option><option value='/template23'>Đồng Tháp </option><option value='/template24'>Gia Lai </option><option value='/template25'>Hà Giang </option><option value='/template26'>Hà Nam </option><option value='/template27'>Hà Tây </option><option value='/template28'>Hà Tĩnh </option><option value='/template29'>Hải Dương </option><option value='/template30'>Hải Phòng </option><option value='/template31'>Hòa Bình </option><option value='/template32'>Hưng Yên </option><option value='/template33'>Khánh Hòa </option><option value='/template34'>Kiên Giang </option><option value='/template35'>Kon Tum </option><option value='/template36'>Lai Châu </option><option value='/template37'>Lâm Đồng </option><option value='/template38'>Lạng Sơn </option><option value='/template39'>Lào Cai </option><option value='/template40'>Long An </option><option value='/template41'>Nam Định </option><option value='/template42'>Nghệ An </option><option value='/template43'>Ninh Bình </option><option value='/template44'>Ninh Thuận </option><option value='/template45'>Phú Yên </option><option value='/template46'>Phú Thọ </option><option value='/template47'>Quảng Bình </option><option value='/template48'>Quảng Ngãi </option><option value='/template49'>Quảng Ninh </option><option value='/template50'>Quảng Trị </option><option value='/template51'>Sóc Trăng </option><option value='/template52'>Sơn La </option><option value='/template53'>Tây Ninh </option><option value='/template54'>Thái Bình </option><option value='/template55'>Thái Nguyên </option><option value='/template56'>Thanh Hóa </option><option value='/template57'>Thừa Thiên Huế </option><option value='/template58'>Tiền Giang </option><option value='/template59'>Trà Vinh </option><option value='/template60'>Tuyên Quang </option><option value='/template61'>Vĩnh Long </option><option value='/template62'>Vĩnh Phúc </option><option value='/template63'>Yên Bái </option>					
            </select>
        </td>
    ...
    <tr>
        ...
        <td style="width: 110px"><input type="text" name="Number" id="Number" value='/template<c:out value="${prt.head_of_parentage_number}"></c:out>'></td>
        <td style="width: 200px">Email Ngưởi tạo</td>
      	<td style="width: 120px"><input type="text" name="Email" id="Email" value='/template<c:out value="${prt.head_of_parentage_email}"></c:out>'></td>
        <td>Địa chỉ người tạo</td>
        <td><input type="text" name="Address" id="Address" value='/template<c:out value="${prheadadr}"></c:out>'></td>
